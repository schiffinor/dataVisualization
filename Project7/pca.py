...
class PCA:
    ...
    def __init__(self, data_: pd.DataFrame):
        ...
        :param data: pandas DataFrame. shape=(num_samps, num_vars)
    ...
    def compute_prop_var(e_vals: np.ndarray):
        ...
        :param e_vals: ndarray. shape=(num_pcs,)

        :return Python list. len = num_pcs
    ...
    def compute_cum_var(prop_var: List[float]):
        ...
        :param prop_var: Python list. len(prop_var) = num_pcs
    ...
    def pca_project(self, pcs_to_keep: List[int]):
        ...
        :param pcs_to_keep: Python list of ints. len(pcs_to_keep) = num_pcs_to_keep
            Project the data onto these PCs.
            NOTE: This LIST contains indices of PCs to project the data onto, they are NOT necessarily
            contiguous.
            Example 1: [0, 2] would mean project on the 1st and 3rd largest PCs.
