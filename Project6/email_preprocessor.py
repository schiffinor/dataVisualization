...
def count_words(email_path='data/enron'):
    ...
    # Get files in the email_path directory
...
def find_top_words(word_freq, num_features=200):
    ...
    # Get the top num_features words and counts
...
def make_feature_vectors(top_words, num_emails, email_path='data/enron'):
    ...
    """
    # Initialize the feature matrix and class labels
            ...
            with open(os.path.join(root, file), 'r') as f:
                ...
                for word in words:
                    if word in top_words:
                        feats[email_num, top_words.index(word)] += 1
