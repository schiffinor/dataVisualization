...
class CatData(data.Data):
    ...
    def get_cat_levels_str(self, header):
        ...
        """
        return np.array(list(self.cats2level_dicts[header].keys()))
    ...
    def get_cat_levels_int(self, header):
        ...
        """
        return np.array(list(self.cats2level_dicts[header].values()))
    ...
    def int2strlevels(self, header, int_levels):
        ...
        """
        return [self.levels2cats_dicts[header][i] for i in int_levels]
    ...
    def str2intlevels(self, header, str_levels):
        ...
        """
        return [self.cats2level_dicts[header][str] for str in str_levels]
